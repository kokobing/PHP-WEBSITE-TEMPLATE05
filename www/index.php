...
<div id="slides">
                ...
                <?php for($i=0;$i<sizeof($arrallpicinfo);$i++){?>
					<div class="slide">
                        ...
                        <div class="caption">
    <h1 style="width:580px;font-family:SimHei;font-size: 40pt;color: #fff;text-decoration: none;line-height: 80px;text-align:left; "><?=$arrallpicinfo[$i][title]?></h1>
    <p style="width:500px;font-family:SimHei;font-size: 10pt;color: #fff;text-decoration: none;line-height: 20px;text-align:left;"><?=$arrallpicinfo[$i][intro]?></p>
                        </div>
					</div>
                    <?php }?>
...
<div id="homecontent1">
<h1>公司简介</h1>
<h2><a href="/about/aboutus.php"><?=cutstr($aboutus[intro],230,1);?></a></h2>
<div id="more"><a href="/about/aboutus.php">查看更多</a></div>
</div>
<div id="homecontent1"><h1>新品介绍</h1>
<h2><?=$newproduct[title]?><br />
    <br />
      <img src="/upload/layout/<?=$newproduct[pic]?>" width="182" height="99" /></h2>
<div id="more"><a href="/product/product.php">查看更多</a></div>
</div>
<div id="homecontent1"><h1>解决方案</h1>
<h2><a href="/case/case.php"><?=$caseinfo[content];?></a></h2>
<div id="more"><a href="/case/case.php">查看更多</a></div>
</div>
<div id="homecontent1"><h1>新闻动态</h1>
<div id="homenews1">
<ul>
<? for($i=0;$i<sizeof($arrallnews);$i++){?>
<li><a href="/news/newspage.php?newsid=<?=$arrallnews[$i][id_newsinfo];?>&ndir=<?=$arrallnews[$i][id_newsdir];?>" class="link_navi"><?=cutstr($arrallnews[$i][title],33,0)?></a></li>
<? }?>
</ul>
</div>
<div id="more"><a href="/news/news.php">查看更多</a></div>
</div>

</div><!--end homecontent!-->

<div id="homenewstxt">
<div id="homenewstxt_title">最新消息：</div>
