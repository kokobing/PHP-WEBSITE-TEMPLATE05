...
$intRows = 15;
$strSQLNum = "SELECT COUNT(*) as num from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.lang=0  and a.id_newsdir not in(27,28) and fatherid='1' ";   
...
$strSQL = "select a.* from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.lang=0  and a.id_newsdir not in(27,28)  and fatherid='1'  order by a.ordernum desc" ;
