...
<div id="hidetitlepic<?=$i;?>" style="position:absolute;left:0px;top:0px; width:166px; display:none; z-index:100; background-color:#CCC"><?php echo cutstr($onenewspicinfo[$i][title],30,0);?></div>
</div>
