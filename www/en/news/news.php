...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr height="28">
    <td width="629" align="left" style="background:url(/inc/pics/bg2.gif) repeat-x left bottom;">&nbsp;<img src="/inc/pics/arr.gif" width="11" height="14" align="absmiddle" />&nbsp;&nbsp;<a href="/en/news/newspage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>&ndir=<?=$arrnews[$i][id_newsdir];?>" class="link_navi"><?=$arrnews[$i][title];?></a></td>
