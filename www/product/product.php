...
<div id="aboutcontent1">
          ...
          <table width="150" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 22px" class="txt">
            <tr>
              <td width="150" align="center" style="padding:2px; border:1px solid #C6C6C6"><a href="/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo];?>&id1=<?=$arrprods[$i][fatherid];?>&id2=<?=$arrprods[$i][id_proddir];?>" target="_blank" ><img src="/upload/product/<?=$arronepic[pic];?>" border="0" /></a></td>
            </tr>
            <tr>
